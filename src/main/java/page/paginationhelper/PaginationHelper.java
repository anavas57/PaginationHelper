...
/**
 * PaginationHelper() - Class to be used for the implementation of pagination UI components
...
public class PaginationHelper {
    ...
    public int pagesCount() {
        if (itemsDataSet == null || itemsDataSet.length == 0 || itemsPerPage <= 0) {
            ...
            int totalPages = itemsDataSet.length / itemsPerPage;
            int itemsRemaining = itemsDataSet.length % itemsPerPage;
            if (itemsRemaining == 0) {
                return totalPages;
            } else {
                return totalPages + 1;
    ...
    /**
     * itemsPerPageCount() - This method returns the number of items in a given page.
     *                       Page numbers start from 0.
     *
     * @param pageNumber Current page number.
     * @return
     */
    public int itemsPerPageCount(int pageNumber) {
